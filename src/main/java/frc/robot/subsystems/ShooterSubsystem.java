...
import frc.robot.generated.TunerConstants.FeederSetpoints;
import frc.robot.generated.TunerConstants.FlywheelSetpoints;
  ...
  private double flywheelTargetVelocity = 0.0;
   ...
   public ShooterSubsystem() {
     ...
     flywheelMotor.configure(
         Configs.ShooterSubsystemConfigs.flywheelConfig,
         ResetMode.kResetSafeParameters,
         PersistMode.kPersistParameters);
     flywheelFollowerMotor.configure(
         Configs.ShooterSubsystemConfigs.flywheelFollowerConfig,
         ResetMode.kResetSafeParameters,
         PersistMode.kPersistParameters);
     feederMotor.configure(
         Configs.ShooterSubsystemConfigs.feederConfig,
         ResetMode.kResetSafeParameters,
         PersistMode.kPersistParameters);
